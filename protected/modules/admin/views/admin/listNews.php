            ...
            <table class="adminlist">
               <tbody>
                  ...
                  <tr>
                     ...
                     <td><a href="<?php echo Yii::app()->request->baseUrl.'/admin/EditNews/'.$item->id; ?>">Edit</a>
                        &nbsp; &nbsp; &nbsp;
                        <a href="<?php echo Yii::app()->request->baseUrl.'/admin/DeleteNews/'.$item->id; ?>">Delete</a>
                  </tr>
                  <?php } ?>
                  <tr>
