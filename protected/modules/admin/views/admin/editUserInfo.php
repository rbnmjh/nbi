                           ...
                           <table class="adminform">
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <?php
                                          echo $form->textField($user, 'first_name', array('class' => 'required text_area', 'maxlength' => '100'));
                                       ?>
                                    </td>
                                 </tr>
                                  <tr>
                                    ...
                                    <td>
                                       <?php
                                          echo $form->textField($user, 'last_name', array('class' => 'required text_area', 'maxlength' => '100'));
                                       ?>
                                    </td>
                                 </tr>
                                 <tr>
