                     ...
                     <tr>
                        <td valign="top">
                           <table class="adminform">
                              <tbody>
                                 <tr>
                                    <th colspan="2">Add Wine:</th>
                                 </tr>
                                 <tr>
                                    <td><label for="#">Title:<span>*</span></label></td>
                                    <td>
                                       <?php
                                          echo $form->textField($wine, 'title', array('class' => 'required text_area', 'maxlength' => '100'));
                                       ?>
                                    </td>
                                 </tr>
                                 <tr>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <span class="text-wrapper">
                                          <?php
                                             echo $form->textArea($wine, 'description', array('class'  => 'required text_area', 'maxlength' => '100'));
                                          ?>
                                       </span>
                                    </td>
                                 </tr>
