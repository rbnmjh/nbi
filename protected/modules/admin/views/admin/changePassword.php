                           ...
                           <table class="adminform">
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                          <?php echo CHtml::passwordField('user[old_password]', '', array('id'    => 'old_password', 'class' => "required text_area")); ?>
                                    </td>
                                 </tr>
                                 <tr>
                                 </tr>
                                 <tr>
                                    ...
                                    <td>
                                       <span class="text-wrapper">
                                          <?php echo CHtml::passwordField('user[new_password]', '', array('id'    => 'new_password', 'class' => "required text_area")); ?>
                                       </span>
                                    </td>
                                 </tr>
                                 <tr>
                                    ...
                                    <td>
                                       <span class="text-wrapper">
                                         <?php echo CHtml::passwordField('user[conform_password]', '', array('id'    => 'conform_password', 'class' => "required text_area")); ?>
                                       </span>
                                    </td>
                                 </tr>
                                 <tr>
