                     ...
                     <tr>
                        <td valign="top">
                           <table class="adminform">
                              <tbody>
                                 <tr>
                                    <th colspan="2">Edit About us:</th>
                                 </tr>
                                 <tr>
                                    <td><label for="#">Title:<span>*</span></label></td>
                                    <td>
                                       <?php
                                          echo $form->textField($AboutUs, 'page_title', array('class' => 'required text_area', 'maxlength' => '100'));
                                       ?>
                                    </td>
                                 </tr>
                                 <tr>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <span class="text-wrapper">
                                          <?php
                                             echo $form->textArea($AboutUs, 'content', array('class'  => 'required text_area', 'maxlength' => '100', 'style'=> 'width: 725px;'));
                                          ?>
                                       </span>
                                    </td>
                                 </tr>
